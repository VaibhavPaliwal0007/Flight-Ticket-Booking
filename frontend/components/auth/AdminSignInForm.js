...
import { adminLogin } from '@/pages/api/authentication';
...
export default function AdminSignInForm() {
    const [isError , setisError] = useState("errr");
                        ...
                        <form onSubmit={loginHandler} className="space-y-4 md:space-y-6" action="#">
                            ...
                            <Link href="/home">
                                <button
                                    ...
                                    className="bg-gray-800 text-white w-full text-black bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 my-4"
