...
const SignUpForm = (props) => {
  ...
  return (
    <section className="bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto mt-20 md:h-screen lg:py-0">
          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" action="#">
              ...
              <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                ...
                <Link href="/signin" className="font-medium text-primary-600 hover:underline dark:text-primary-500 my-4">
                  Login here
                </Link>
              </p>
            </form>
