                ...
                <div className="flow-root">
                    <ul role="list" className="divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <li className="flex justify-around pt-3 pb-0 sm:pt-4">
                            <button type="button" class="focus:outline-none text-black bg-blue-200 hover:bg-blue-400 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2  " onClick={viewHandler}>View</button>
                            <button type="button" class="focus:outline-none text-black bg-blue-200 hover:bg-blue-00 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 " onClick={bookingHandler}>Book</button>
                        </li>
                    </ul>
                </div>
            </div>
